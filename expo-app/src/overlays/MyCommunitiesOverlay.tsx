...
export function MyCommunitiesOverlay() {
  ...
  // The shared loader, because this screen and the Chat tab both need the
  // same answer and both used to read an empty store.
  const { communities: mine, loading } = useMyCommunities();
